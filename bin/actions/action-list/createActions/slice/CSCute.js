...
export const CSCute = (fsdPath, layerIncoming, sliceIncoming) => {
    ...
    const iSuccess = createSliceComponent(fsdPath, layer, sliceName, componentName);
    if (!iSuccess) {
        return CSCute(fsdPath, layer, sliceName);
    }
    return true;
};
//# sourceMappingURL=CSCute.js.map